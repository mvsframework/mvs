...
#ifndef DIRECTEDRFGRAPH_H
#define DIRECTEDRFGRAPH_H

#include "Graph/rfgraph.h"

/** \brief The dedicated namespace for a R/F graph. */
namespace DirectedRfGraph {
...
using Vertex_Properties = RfGraph::Vertex_Properties;
  
  
/** \brief The (nested) internal edge properties of the graph. */  
using Edge_Properties = RfGraph::Edge_Properties;
