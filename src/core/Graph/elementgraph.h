...
/** \brief The dedicated namespace for the element graph. */
namespace ElementGraph {
...
using Vertex_BorderFlag_Map   = property_map<Graph, vertex_borderFlag_t>::type;

using Edge_Index_Map          = property_map<Graph,edge_index_t>::type;


}; // end namespace ElementGraph


#endif // ELEMENTGRAPH_H
